...
$1\unit{y}=\int\limits_{r_E}^a\frac{dx}{\sqrt{2m / \left(mGm_E\left(\frac 1x-\frac 1a\right)\right)}}$, wobei $E_{kin;0}+E_{pot;0}=E_{pot}(a)$, wobei $a$ der Ort ist wo der Körper umkehrt, sodass $E_{kin;0}(a)=0$ ist.  Dieses Integral kann mit der Substitution $x=a\sin\phi$ gelöst werden.
  \end{abcenum}
\end{solution}
\end{problem}
...
\item Bestimmen Sie, wie groß das Tastverhältnis gewählt werden muss, um einen Kondensator einer Kapazität von $100\unit{\mu F}$ mit einer $12\unit{V}$ Batterie auf eine Spannung von $500\unit{V}$ aufzuladen, wenn die Induktivität der Spule $5\unit{mH}$ beträgt.
\end{abcenum}
...
\theta'=\arccos\left(\frac{\cos\theta -\beta}{1-\beta\cos\theta}\right)
  \end{align*}
    \item
      ...
      \end{align*}
      $\cos\theta'=\cos 150\unit{\cel}=-\cos 30\unit{\cel}=-\frac {\sqrt{3}}2$, $\cos\theta=\frac{20000\unit{ly}}{\frac 12 100000\unit{ly}}=\frac 25$.
      \begin{equation*}
