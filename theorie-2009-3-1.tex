...
An der dargestellten Schaltung wird eine Rechteckspannung $U(t)$ mit$U_0 = 6 \unit{V}$ und Pulsdauer $\tau$ angelegt. Man bestimme das asymptotische Verhalten der Potentiale in der Punkten $A$, $B$ unter der Annahme dass die Kondensatoren und die Dioden ideal sind.
%\begin{solution}
%\end{solution}
\end{problem}
