...
\begin{solution}
% ?
Diese Formeln könnten Sinn ergeben (oder auch nicht).
\[
\Delta h=\frac{q^2}{8 \pi \varepsilon_0 m g L}-\frac L2 \tan\alpha
\]
\[
\Delta h=l \sin\alpha \cos^2 \alpha+ \frac{2 q^2 l \cos\alpha}{4 \pi \varepsilon_0 m g L (L+2 l \cos\alpha)}
\]
\end{solution}
\end{problem}
...
\begin{solution}
3 mal Knotenregel ($\sum\frac U R = 0$):\\
\[
 \frac 1 2 (0-\varphi_{\textnormal{aus}}) + \frac 1 2 (\varphi_1-\varphi_{\textnormal{aus}}) + (\varphi_5-\varphi_{\textnormal{aus}}) = 0
\]
\[
 (\varphi_{\textnormal{aus}}-\varphi_5) + \frac 1 2 (\varphi_2-\varphi_5) + (\varphi_6-\varphi_5) = 0
\]
\[
...
\[
 \varphi_{\textnormal{aus}} = \frac 1 3 \left(\varphi_1+\frac 1 2 \varphi_2+\frac 1 4 \varphi_3\right)
\]
\end{solution}
\end{problem}
